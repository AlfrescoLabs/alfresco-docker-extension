export const resources = {
    ...
    LIST : {
              ...
              ALFRESCO_CONTAINERS_LIST_ERROR : "At least one of the containers was unable to run. In the above list is identified with Status EXITED. Please hit button Stop and review the details of the error in the container before trying again."
            },
  }
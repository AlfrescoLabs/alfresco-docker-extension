export const resources = {
  HOME: {
    ...
    RAM_ALERT_MESSAGE:
      "Despite ACS may work with less than 10 GB RAM, it's recommended to use at least this amount of RAM. Review Docker Desktop configuration to increase this resource.",
  ...
  LIST: {
    ...
    ALFRESCO_CONTAINERS_LIST_ERROR:
      'At least one of the containers was unable to run. In the above list is identified with Status EXITED. Please review the details of the error in the container before trying again.',
  },
};
